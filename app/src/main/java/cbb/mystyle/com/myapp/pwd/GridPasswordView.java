package cbb.mystyle.com.myapp.pwd;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.gridpwd_view, this);
        ...
        while (index < passwordLength) {
            View dividerView = inflater.inflate(R.layout.gridpwd_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.gridpwd_tv, null);

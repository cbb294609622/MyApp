...
import com.mining.app.zxing.camera.CaptureActivityHandler;
import com.mining.app.zxing.camera.InactivityTimer;
...
public class MipcaCaptureActivity extends Activity implements Callback, View.OnClickListener {
    ...
    public void onBackPressed() {
        finish();
        ActivityAnimUitl.isLeftRight(MipcaCaptureActivity.this);
        super.onBackPressed();
    }
}